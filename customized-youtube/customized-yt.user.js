...
// @downloadURL   https://update.greasyfork.org/scripts/498985/customized-youtube.js
// @updateURL     https://update.greasyfork.org/scripts/498985/customized-youtube.js
    ...
    function createCustomDownloader() {
        function checkExistence() {
            ...
            if (targetDiv) {
                ...
                appendInfobox(targetDiv);
            }
        }

        function appendInfobox(targetDiv) {
            ...
            link.href = getModifiedUrl(window.location.href);
            link.target = "_blank";
        ...
        function getModifiedUrl(url) {
            ...
            if (index !== -1) {
                return url.slice(0, index) + "pp" + url.slice(index);
            } else {
                return url;
            }
        }
        ...
        checkExistence();
        var intervalId = setInterval(checkExistence, 100);
    }
...
(function() {
    ...
    const youtubeStyles = `
        body {
            background: url(https://res.cloudinary.com/dk5jbudni/image/upload/v1719409306/yt-bg_phrrfb.png) no-repeat !important;
    ...
    const popupHTML = `
        <div id="settingsPopup" style="display: none; position: fixed; top: 50%; left: 50%; transform: translate(-50%, -50%); background: rgba(0, 0, 0, 0.85) !important; color: #fff !important; padding: 40px; padding-left: 55px; padding-right: 55px; border: 1px solid #ccc; border-radius: 15px; z-index: 1000;">
            <h3 style="margin-top: 0; margin-bottom: 5px; font-size: 15px;">Settings</h3>
            <label for="backgroundUrl">Background Image URL for Body:</label><br>
            <input type="text" id="backgroundUrl" style="width: 350px; margin-bottom: 10px; margin-top: 10px; background: rgb(125, 125, 150) !important; border-radius: 10px; border: 0px;"><br>
            <label for="chatBackgroundUrl">Background Image URL for Chat:</label><br>
            <input type="text" id="chatBackgroundUrl" style="width: 350px; margin-bottom: 10px; margin-top: 10px; background: rgb(125, 125, 150) !important; border-radius: 10px; border: 0px;"><br>
            <label for="enableProgressBar" style="margin-bottom: 10px;">Enable NyanProgressBar:</label>
            <input type="checkbox" id="enableProgressBar""><br><br>
            <button id="saveSettingsBtn" style="padding: 5px 10px; background: rgba(0, 150, 0, 0.75) !important; color: #fff !important; border-radius: 15px; border: 0px; cursor: pointer;">Save</button>
    ...
    function saveSettings() {
        ...
        if (chatBackgroundUrl) {
            GM_addStyle(`
                .style-scope.yt-live-chat-renderer.iron-selected {
                    background-image: url(${chatBackgroundUrl}) !important;
                }
            `);
        }
    ...
    function createSettingsButton() {
        ...
        if (container) {
            ...
            settingsButton.style.cssText = `
                ...
                width: 22px;
                height: 22px;
                background-image: url(https://res.cloudinary.com/dk5jbudni/image/upload/v1719411796/settings_g9lgti.svg);
    ...
    function init() {
        ...
        if (youtubeUrlRegex.test(document.location.href)) {
            ...
            if (savedBackgroundUrl) {
                GM_addStyle(`
                    body {
                        background-image: url(${savedBackgroundUrl}) !important;
                    }
                `);
            ...
            if (savedChatBackgroundUrl) {
                GM_addStyle(`
                    .style-scope.yt-live-chat-renderer.iron-selected {
                        background-image: url(${savedChatBackgroundUrl}) !important;
                    }
                `);
            ...
            if (enableProgressBar) {
                injectProgressBarStyles();
                document.getElementById('enableProgressBar').checked = true;
            }
        }
    }
